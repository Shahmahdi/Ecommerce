...
import { Icon, Intent, Button, Dialog } from "@blueprintjs/core";
import { PaymentForm } from '../components/braintree/PaymentForm'

export const CartPage = () => {

  const [cartUpdateToggle, setCartUpdateToggle] = useState(false);
  const [showBraintreePaymentForm, setShowBraintreePaymentForm] = useState(false);
  ...
  return (
    <>
      ...
      {showBraintreePaymentForm && (
        <Dialog
          onClose={() => setShowBraintreePaymentForm(!showBraintreePaymentForm)}
          isOpen={showBraintreePaymentForm}
          style={{ background: '#fff' }}
          canOutsideClickClose={false}
        >
          <PaymentForm setShowBraintreePaymentForm={setShowBraintreePaymentForm} />
        </Dialog>
      )}
    </>
  )
